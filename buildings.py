# -*- coding: utf-8 -*-
"""
Created on Thu Jun  3 17:40:48 2021
...
X = []
y = []
train_path = r'C:\Users\Batur\Desktop\seg_train\seg_train\buildings'
...
def model1() :
    ...
    convt1 = tf.keras.layers.Conv2DTranspose(128,3,padding='same',activation='relu') (conv3)
    convt2 = tf.keras.layers.Conv2DTranspose(128,3,padding='same',activation='relu') (convt1)
    out = tf.keras.layers.Conv2DTranspose(3,3,padding='same',activation='sigmoid') (convt2)
...
hist = model.fit(X,y,epochs=13,batch_size=16,validation_split=0.2)
...
with open("modelbuildings.json","w") as json_file:
    json_file.write(model_json)
model.save_weights("modelbuildings.h5")
...
#%%
pred = model.predict(X[23].reshape(1,150,150,1))
