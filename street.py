# -*- coding: utf-8 -*-
"""
Created on Thu Jun  3 17:41:18 2021
...
X = []
y = []
train_path = r'C:\Users\Batur\Desktop\seg_train\seg_train\street'
...
def model1() :
    ...
    conv4 = tf.keras.layers.Conv2D(128,3,padding='same',activation='relu') (convt3)
    out = tf.keras.layers.Conv2DTranspose(3,3,padding='same',activation='sigmoid') (conv4)
...
hist = model.fit(X,y,epochs=30,batch_size=16,validation_split=0.2)
...
#%%
pred = model.predict(X[13].reshape(1,150,150,1))
