# -*- coding: utf-8 -*-
"""
Created on Thu Jun  3 17:41:13 2021
...
X = []
y = []
train_path = r'C:\Users\Batur\Desktop\seg_train\seg_train\sea'
...
def model1() :
    ...
    conv3 = tf.keras.layers.Conv2D(128,3,padding='same',activation='relu') (convt2)
    out = tf.keras.layers.Conv2DTranspose(3,3,padding='same',activation='sigmoid') (conv3)
...
with open("modelsea.json","w") as json_file:
    json_file.write(model_json)
model.save_weights("modelsea.h5")
...
#%%
pred = model.predict(X[100].reshape(1,150,150,1))

pred = pred.reshape(150,150,3)
plot_pair(X[100],pred)
